...
/**
 * ProgressPaneCancelListener is a listener that receives
 *  ProgressPaneCancelEvent events.
 * @author Antonio Vieiro (vieiro@dev.java.net)  $Author$
 * @version $Revision: $
 */
public interface ProgressPaneCancelListener
  extends EventListener
{
  public void progressPaneCancelPressed( ProgressPaneCancelEvent anEvent );
}
